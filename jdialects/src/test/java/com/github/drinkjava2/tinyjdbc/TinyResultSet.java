...
/**
 * This class creates a very simple offline version ResultSet.
 *
 * @author Yong Zhu
 */
@SuppressWarnings({ "rawtypes", "unchecked" })
public class TinyResultSet implements Serializable {
	private static final long serialVersionUID = -3774366266933592966L;
	private String[] columnNames;
	private List rowMap;
	private Boolean isLimited;

	/**
	 * This constructor reads the ResultSet and saves a cached copy. It's
	 * important to note that this object will be serializable only if the
	 * objects returned by the ResultSet are serializable too.
	 *
	 * @param rs
	...
	public <T> TinyResultSet(ResultSet rs, int startRow, int maxRows, Class<T> requiredType) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static TinyResultSet toResult(ResultSet rs) throws SQLException {
		return new TinyResultSet(rs, -1, -1, Object.class);
	}
	 ...
	 * @throws SQLException
	 */
	public static TinyResultSet toResult(ResultSet rs, int maxRows) throws SQLException {
		return new TinyResultSet(rs, -1, maxRows, Object.class);
	}
	 ...
	 * @throws SQLException
	 */
	public static <T> TinyResultSet toResult(ResultSet rs, Class<T> requiredType) throws SQLException {
		return new TinyResultSet(rs, -1, -1, requiredType);
	}
	 ...
	 * @throws SQLException
	 */
	public static <T> TinyResultSet toResult(ResultSet rs, int maxRows, Class<T> requiredType) throws SQLException {
		return new TinyResultSet(rs, -1, maxRows, requiredType);
	}
	...
	/**
	 * Return a String included all info for debug use
	 */
