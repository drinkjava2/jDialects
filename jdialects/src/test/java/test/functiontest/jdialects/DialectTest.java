...
import static com.github.drinkjava2.jdialects.Dialect.MySQL5InnoDBDialect;
import static com.github.drinkjava2.jdialects.Dialect.MySQLInnoDBDialect;
...
public class DialectTest {
	...
	public void testGuessDialectsByDatabaseName() {
		...
		Assert.assertEquals(MySQLInnoDBDialect, Dialect.guessDialect("MySQL"));
		Assert.assertEquals(MySQL5InnoDBDialect, Dialect.guessDialect("MySQL", 5, 0));
