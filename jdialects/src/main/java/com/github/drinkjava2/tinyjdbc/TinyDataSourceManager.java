 ...
 * @since 1.0.0
 */
public class TinyDataSourceManager {
	...
	private static class SpringDataSourceManagerClass {
		private static final TinyDataSourceManager INSTANCE = new TinyDataSourceManager(
				"org.springframework.jdbc.datasource.DataSourceUtils");
	}

	public static final TinyDataSourceManager springDataSourceManager() {
		return SpringDataSourceManagerClass.INSTANCE;
	}

	private static class JdbcDataSourceManagerClass {
		private static final TinyDataSourceManager INSTANCE = new TinyJdbcDataSourceManager();
	}

	public static final TinyDataSourceManager jdbcDataSourceManager() {
		return JdbcDataSourceManagerClass.INSTANCE;
	}

	public TinyDataSourceManager() {
	}
	 ...
	 */
	public TinyDataSourceManager(String dataSourceUtilClassName) {
		try {
	...
	public TinyDataSourceManager(Class<?> dataSourceUtilClass) {
		cacheMethods(dataSourceUtilClass);
	}
